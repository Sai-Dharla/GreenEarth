...
- **Cornerstone Projects**:
  - 🌳 **Tree Plantation**: Reforesting degraded landscapes and urban tree canopies.
  - 💧 **Clean Water**: Restoring natural watersheds and deploying sustainable community filtration.
  - ♻️ **Plastic-Free Communities**: Municipal and coastal cleanups with zero-waste packaging advocacy.
...
└── images/
    ...
    ├── project1.jpg    # Tree plantation initiative visual
    ├── project2.jpg    # Clean water & watershed protection visual
    ├── project3.jpg    # Plastic-free and recycling project visual
    └── project4.jpg    # Wildlife and biodiversity protection visual
```
...
No build tools or heavy dependencies required. You can launch the site directly:
...
2. **Open in browser:**
   - Double-click `index.html` to open it in your preferred browser, or
...
- **HTML5**: Semantic tags, accessible landmarks, and structured metadata.
- **CSS3**: Modern CSS variables, flexbox, grid, glassmorphic styling, and media queries.
- **JavaScript (ES6+)**: Smooth interactions, mobile nav menu handling, and active section tracking.
